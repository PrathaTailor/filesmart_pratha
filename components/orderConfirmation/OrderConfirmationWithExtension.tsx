                ...
                <div className={styles.smContainer}>
                    ...
                    <div className={styles.summary}>
                        ...
                        <ul className={styles.summaryList}>
                            ...
                            <li>Tax extension filing included</li>
                            <li>Federal Tax filing included</li>
                            <li>State Tax filing included</li>
                            <li>Full Access to IRS Shield</li>
                            <li>Access to course library to learn tax-saving tips and tools</li>
                            <li>Ask our team of tax experts up to 5 questions/month</li>
                        </ul>
                        <p>
                    ...
                    <div className={styles.upcoming}>
                        ...
                        <p>
                            If you need additional time to prepare your taxes, there will also be an option to file a
                            6-month tax extension.
                        </p>
