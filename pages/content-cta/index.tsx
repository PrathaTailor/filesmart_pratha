...
export async function getStaticProps(context: GetStaticPropsContext<{ page: string[]; resolvedUrl: string }>) {
    ...
    const cta = (await builder.get('co-14-cta', builderSectionOptions).toPromise()) || null;
...
export default function ContentCTA({ page, cta }: InferGetStaticPropsType<typeof getStaticProps>) {
    ...
    return (
        <>
            ...
            {show404 ? <DefaultErrorPage statusCode={404} /> : <BuilderComponent model="co-14-cta" content={cta} />}
        </>
    );
}
