...
import { catalogApi, identityApi } from '@atomicleads/tax-client';
import { getDeductions } from '@utils/apiMethods';

builder.init(builderConfig.apiKey);

export const DeductionAnswerContext:any = createContext<catalogApi.DeductionAnswer[]>([]);
...
export async function getStaticProps(context: GetStaticPropsContext<{ page: string[] }>) {
    ...
    const page = (await builder.get('pa-37-quiz-intro', builderPageOptions).toPromise()) || null;
        ...
        <>
            ...
            {show404 ? (
                ...
                <DeductionAnswerContext.Provider value={deductionAnswers}>
                    <BuilderComponent model="pa-37-quiz-intro" content={page} />
