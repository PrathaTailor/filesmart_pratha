...
export default function Page({ page }: InferGetStaticPropsType<typeof getStaticProps>) {
    ...
    return (
        <>
            <Head>
                <title>FileSmart - Terms of Use</title>
                <meta property="og:title" content="FileSmart - Terms of Use" />
                <meta name="description" content="Read Filesmart.tax’s Terms of Service here." />
