...
export default function Page({ page }: InferGetStaticPropsType<typeof getStaticProps>) {
    ...
    return (
        <>
            <Head>
                <title>FileSmart - Privacy Policy</title>
                <meta property="og:title" content="FileSmart - Privacy Policy" />
                <meta name="description" content="Read Filesmart.tax’s Privacy Policy here." />
